...
​
    results = session.query(meteorites.Mass, meteorites.name, meteorites.year,
                            meteorites.reclat, meteorites.reclong, meteorites.GeoLocation, meteorites.id).order_by(meteorites.Mass.desc()).all()
​
    session.close()
​
    mtrarray = []
